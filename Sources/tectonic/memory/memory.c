...
{
	program_memory.default_frame_allocator_storage = allocator_create(calloc(1, frame_memory_size), frame_memory_size, ALLOCATOR_MODE_ARENA);
	program_memory.default_level_allocator_storage = allocator_create(calloc(1, level_memory_size), level_memory_size, ALLOCATOR_MODE_ARENA);
	program_memory.default_permanent_allocator_storage = allocator_create(calloc(1, permanent_memory_size), permanent_memory_size, ALLOCATOR_MODE_ARENA);
